...
app.whenReady().then(() => {
    ...
    ipcMain.on("open-list", () => navigateTo("views/list.html"));
    ipcMain.on("open-create", () => navigateTo("views/create.html"));

    ipcMain.on('open-edit', (event, item) => {
        navigateTo("views/edit.html");
